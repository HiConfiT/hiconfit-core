...
package at.tugraz.ist.ase.hiconfit.csp2choco;

import at.tugraz.ist.ase.hiconfit.common.ChocoSolverUtils;
import at.tugraz.ist.ase.hiconfit.common.LoggerUtils;
import at.tugraz.ist.ase.hiconfit.csp2choco.antlr.CSP2ChocoBaseListener;
import at.tugraz.ist.ase.hiconfit.csp2choco.antlr.CSP2ChocoLexer;
import at.tugraz.ist.ase.hiconfit.csp2choco.antlr.CSP2ChocoParser;
...
public class CSP2ChocoTranslator extends CSP2ChocoBaseListener {
    ...
    private IntVar leftContextTranslate(Model model, ParserRuleContext leftContext) {
        ...
        return (IntVar) ChocoSolverUtils.getVariable(model, id.getText());
    }
    ...
    private Pair<IntVar, Integer> rightContextTranslate(Model model, ParserRuleContext rightContext) {
        ...
        if (rightContext instanceof CSP2ChocoParser.IdContext id) {
            return Pair.with((IntVar) ChocoSolverUtils.getVariable(model, id.getText()), Integer.MIN_VALUE);
        } else {
