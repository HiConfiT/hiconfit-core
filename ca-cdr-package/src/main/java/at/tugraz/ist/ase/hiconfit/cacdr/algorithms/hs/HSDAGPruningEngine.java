...
public class HSDAGPruningEngine extends HSTreePruningEngine {
                                ...
                                for (Node nd : nodes) {
                                    if (nd.getStatus() == NodeStatus.Open) {
                                        ...
                                        for (Constraint label : delete) {
                                            ...
                                            if (child != null) {
                                                PerformanceEvaluator.incrementCounter(AbstractHSConstructor.COUNTER_PRUNING);
    ...
    private void cleanUpNodes(Node node) {
        ...
        if (node.getStatus() == NodeStatus.Open) {
            ...
            PerformanceEvaluator.incrementCounter(AbstractHSConstructor.COUNTER_CLEANED_NODES);
